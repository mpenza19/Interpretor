...
class LemmaTrans:
    ...
    def handle_irreg(self, source_rawlemma, pos):
        if pos in ("u", "intj"): return source_rawlemma
            ...
            if source_rawlemma in ("holy", "saintly", "sainted") and pos == "a": return "sanctus"
            ...
            if source_rawlemma == "of" and pos == "s": return "de"
            ...
            if source_rawlemma in ("my", "mine", "our", "ours") and pos in ("a", "p"): return "meus"
            ...
            if source_rawlemma.startswith("any"): return "alius"
            ...
            if source_rawlemma == ("alone", "only", "solely") and pos == "r": return "solum"
            ...
            if source_rawlemma == ("while", "meanwhile") and pos == "r": return "dum"
            ...
            if source_rawlemma == "than" and pos == "r": return "quam"
